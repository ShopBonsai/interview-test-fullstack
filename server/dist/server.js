...
var models_1 = __importDefault(require("./modules/models"));
...
var server = new apollo_server_express_1.ApolloServer({
    ...
    typeDefs: graphqlSchema_1.typeDefs,
...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, mongoose_1.default.connect(String(process.env.MONGO_URI), {
            ...
            case 2:
                error_1 = _a.sent();
                throw new Error("could not connect to mongoose " + error_1);
